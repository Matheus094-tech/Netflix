const API_KEY = '3d6b66836cdf93a20159e5e4ae67b72f';
...
export default {
    ...
    return [
        ...
        },
        {
            slug: 'action',
            title: 'Ação',
            items: await basicFetch(`/discover/movie?language=PT-BR&with_genres=28$language=pt-BR&api_key=${API_KEY}`)
        },
        {
            slug: 'comedy',
            title: 'Comédia',
